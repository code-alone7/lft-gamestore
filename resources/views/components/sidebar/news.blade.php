<div class="sidebar-news">
  ...
  <div class="sidebar-news__item">
    ...
    <div class="sidebar-news__item__title-news"><a href="{{ route('articles.show', ['article' => $article->id]) }}" class="sidebar-news__item__title-news__link">{{ $article->short_header }}</a></div>
  </div>
  @endforeach
</div>
